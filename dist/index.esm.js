...
function Button({ children }) {
    return jsx("button", { type: "button", children: children });
}
...
var Slot = React.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return /* @__PURE__ */ jsx(SlotClone, { ...slotProps, ref: forwardedRef, children: React.isValidElement(newElement) ? React.cloneElement(newElement, undefined, newChildren) : null });
  }
...
var useReactId = React["useId".toString()] || (() => undefined);
var count = 0;
...
const TooltipContent = React.forwardRef((_a, ref) => {
    ...
    return (jsx(TooltipPortal, { children: jsx(Content2, Object.assign({ ref: ref, sideOffset: sideOffset, className: cn("relative z-50 overflow-visible rounded-md border bg-popover px-3 py-1.5 text-sm text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 dark:bg-dark_bg3 dark:border-dark_border dark:text-dark_text_primary", className) }, props)) }));
});
TooltipContent.displayName = Content2.displayName;

function TextTruncate({ className = "", align = "left", text = "", limit = 30, }) {
    return (text === null || text === undefined ? undefined : text.length) > limit ? (jsx(TooltipProvider, { children: jsxs(Tooltip, { children: [jsx(TooltipTrigger, { asChild: true, type: "button", className: `text-${align}`, children: jsx("span", { className: className, children: `${text.substring(0, limit)}...` }) }), jsx(TooltipContent, { children: text })] }) })) : (jsx("span", { className: className, children: text }));
}
